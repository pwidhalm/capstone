...
df.loc[(df.close_lag1<df.bb_low_lag1) & (df.rsi_lag1<35),'bb_sig'] = 1
# df.loc[(df.close<df.bb_low) & (df.close_lag1<df.bb_low_lag1) & (df.rsi<35),'bb_sig'] = 1
...
df.loc[(df.close_lag1>df.bb_up_lag1) & (df.rsi_lag1>80),'bb_sig'] = -1
# df.loc[(df.close>df.bb_up) & (df.close_lag1>df.bb_up_lag1) & (df.rsi>80),'bb_sig'] = -1
...
# persist df
df.to_csv("./coinbaseBTCUSD-withsignals.csv")
